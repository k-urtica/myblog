...
type SitePageContextNextFields = {
  readonly postPath: Maybe<Scalars['String']>;
};
...
type MarkdownRemarkFrontmatter = {
  ...
  readonly coverCaption: Maybe<Scalars['String']>;
...
type SitePluginPluginOptions = {
  ...
  readonly htmlAttributes: Maybe<SitePluginPluginOptionsHtmlAttributes>;
...
type SitePluginPluginOptionsHtmlAttributes = {
...
type MarkdownRemarkFrontmatterFilterInput = {
  ...
  readonly coverCaption: Maybe<StringQueryOperatorInput>;
...
type MarkdownRemarkFieldsFilterInput = {
  readonly postPath: Maybe<StringQueryOperatorInput>;
};
...
type FileFieldsEnum =
  ...
  | 'childrenMarkdownRemark.frontmatter.coverCaption'
  ...
  | 'childrenMarkdownRemark.fields.postPath'
  ...
  | 'childMarkdownRemark.frontmatter.coverCaption'
  ...
  | 'childMarkdownRemark.fields.postPath'
...
type SitePluginPluginOptionsFilterInput = {
  ...
  readonly htmlAttributes: Maybe<SitePluginPluginOptionsHtmlAttributesFilterInput>;
...
type SitePluginPluginOptionsHtmlAttributesFilterInput = {
...
type SitePageFieldsEnum =
  ...
  | 'pluginCreator.pluginOptions.title'
  | 'pluginCreator.pluginOptions.titleTemplate'
  | 'pluginCreator.pluginOptions.defaultTitle'
  | 'pluginCreator.pluginOptions.description'
  | 'pluginCreator.pluginOptions.language'
  | 'pluginCreator.pluginOptions.canonical'
  | 'pluginCreator.pluginOptions.htmlAttributes.prefix'
  | 'pluginCreator.pluginOptions.openGraph.type'
  | 'pluginCreator.pluginOptions.openGraph.locale'
  | 'pluginCreator.pluginOptions.openGraph.url'
  | 'pluginCreator.pluginOptions.openGraph.site_name'
  | 'pluginCreator.pluginOptions.openGraph.title'
  | 'pluginCreator.pluginOptions.openGraph.description'
  | 'pluginCreator.pluginOptions.openGraph.images'
  | 'pluginCreator.pluginOptions.twitter.site'
  | 'pluginCreator.pluginOptions.twitter.cardType'
...
type SitePluginFieldsEnum =
  ...
  | 'pluginOptions.title'
  | 'pluginOptions.titleTemplate'
  | 'pluginOptions.defaultTitle'
  | 'pluginOptions.description'
  | 'pluginOptions.language'
  | 'pluginOptions.canonical'
  | 'pluginOptions.htmlAttributes.prefix'
  | 'pluginOptions.openGraph.type'
  | 'pluginOptions.openGraph.locale'
  | 'pluginOptions.openGraph.url'
  | 'pluginOptions.openGraph.site_name'
  | 'pluginOptions.openGraph.title'
  | 'pluginOptions.openGraph.description'
  | 'pluginOptions.openGraph.images'
  | 'pluginOptions.openGraph.images.url'
  | 'pluginOptions.twitter.site'
  | 'pluginOptions.twitter.cardType'
  | 'pluginOptions.name'
  | 'pluginOptions.path'
...
type SEOQuery = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'siteUrl'>> }> };

type PostByCategoryQueryVariables = Exact<{
  category: Maybe<Scalars['String']>;
}>;


type PostByCategoryQuery = { readonly allMarkdownRemark: (
    ...
    & { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: Maybe<(
        ...
        )>, readonly fields: Maybe<Pick<MarkdownRemarkFields, 'postPath'>> } }> }
  ) };

type PostByTagQueryVariables = Exact<{
  tag: Maybe<Scalars['String']>;
}>;


type PostByTagQuery = { readonly allMarkdownRemark: (
    Pick<MarkdownRemarkConnection, 'totalCount'>
    & { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: Maybe<(
          Pick<MarkdownRemarkFrontmatter, 'title' | 'date'>
          & { readonly cover: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> }
...
type AllTagQuery = { readonly allMarkdownRemark: { readonly group: ReadonlyArray<Pick<MarkdownRemarkGroupConnection, 'fieldValue' | 'totalCount'>> } };
...
type BlogPostQuery = { readonly markdownRemark: Maybe<(
    ...
    & { readonly frontmatter: Maybe<(
      Pick<MarkdownRemarkFrontmatter, 'title' | 'summary' | 'category' | 'date' | 'updatedAt' | 'tags'>
      & { readonly cover: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> }
    )>, readonly headings: Maybe<ReadonlyArray<Maybe<Pick<MarkdownHeading, 'value' | 'depth' | 'id'>>>>, readonly fields: Maybe<Pick<MarkdownRemarkFields, 'postPath'>> }
  )> };

type AllPostsQueryVariables = Exact<{ [key: string]: never; }>;


type AllPostsQuery = { readonly allMarkdownRemark: { readonly edges: ReadonlyArray<{ readonly node: { readonly frontmatter: Maybe<(
          Pick<MarkdownRemarkFrontmatter, 'title' | 'date' | 'summary' | 'category' | 'tags'>
          & { readonly cover: Maybe<{ readonly childImageSharp: Maybe<Pick<ImageSharp, 'gatsbyImageData'>> }> }
        )>, readonly fields: Maybe<Pick<MarkdownRemarkFields, 'postPath'>> } }> }, readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };
...
type AllCategoryQueryVariables = Exact<{ [key: string]: never; }>;


type AllCategoryQuery = { readonly allMarkdownRemark: { readonly group: ReadonlyArray<Pick<MarkdownRemarkGroupConnection, 'fieldValue' | 'totalCount'>> } };
